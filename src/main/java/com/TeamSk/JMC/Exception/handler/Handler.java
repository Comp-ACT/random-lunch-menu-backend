...
import com.TeamSk.JMC.Exception.RestaurantNotFoundException;
...
public class Handler {
    ...
    public void restaurantNotFoundExceptionHandler(Long restaurantId, Optional<Restaurant> restaurantOptional) {
        if (!restaurantOptional.isPresent()) {
            ...
            throw new RestaurantNotFoundException("RestaurantNotFoundException : restaurantId(" + restaurantId + ")에 대한 restaurant 없습니다.");
        }
    }
}
